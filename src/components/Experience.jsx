    ...
    <section id="experience" className="py-24 bg-pastel-radial relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            {experiences.map((exp) => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-5 rounded-3xl transition-all duration-200 flex items-start justify-between border ${
                    isSelected
                ...
                >
                  <div className="flex items-start gap-3.5">
                    <div className={`mt-1 w-3 h-3 rounded-full ${colors.dot} shrink-0`} />
                    <div>
          ...
          {/* Right: Detailed Experience View (7 cols) */}
          <div className="lg:col-span-7">
            <div className="p-8 sm:p-10 rounded-4xl bg-white dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700/80 shadow-pastel-lg backdrop-blur-xl animate-fadeIn">
              ...
              <div className="pt-6 border-t border-slate-100 dark:border-slate-700">
                ...
                <div className="flex flex-wrap gap-2">
                  {activeExp.techStack.map((tech, idx) => (
                    <span
                      key={idx}
                      className="px-3 py-1 rounded-xl text-xs font-semibold bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-600"
                    >
                      {tech}
                    </span>
                  ))}
